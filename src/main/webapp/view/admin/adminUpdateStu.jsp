                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="${pageContext.request.contextPath}/admin/updateStu" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" <%--style="width: 600px"--%> id="class_id" name="class_id">
                                                        <option  name="class_id" value="${class_id}">${class_name}</option>
                                                        <c:forEach var="cl" items="${requestScope.get('classes')}" >
                                                            <option  name="class_id" value="${cl.class_id}">${cl.class_name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>

            ...
            <div class="ftdms-layout-sidebar-scroll">
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item active"> <a href="${pageContext.request.contextPath}/admin/classes"><i class="ftsucai-82"></i>班级信息</a> </li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="${pageContext.request.contextPath}/admin/addClass" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="class_name" type="text" id="example-nf-name" required="required" >
                                                </div>
